...
require_once '../../controller\RController.php'; // Contrôleur pour les réservations
...
if (isset($_GET['idP'])) {
    ...
    $reservations = $Rc->getReservationsByEvent($idP); // Correction ici
} else {
...
<div class="container">
    <h2 class="text-center">Détails du Evenement</h2>
