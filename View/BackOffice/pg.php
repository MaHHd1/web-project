          ...
          <div class="page-inner">
            ...
            <div class="row">
              ...
              <div class="card">
                ...
                <a href="../front/index.php" class="btn btn-primary btn-sm">front office</a>

                <div class="d-flex justify-content-between align-items-center">
                  <div class="card-title">Listes Des Events</div>
                      ...
                      ?>
                          <tr>
                              ...
                              <img src="data:image/png;base64,<?= base64_encode($produit['image']); ?>" alt="Product Image" style="width: 70px; height: 50px;">
                                ...
                                <td>
                                  <a href="miseaJourProduit.php?idP=<?php echo $produit['id']; ?>" class="btn btn-warning btn-sm">Mise à jour</a>
                                </td>
                                <td>
