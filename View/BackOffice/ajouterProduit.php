...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['productImage']) && $_FILES['productImage']['error'] == UPLOAD_ERR_OK) {
        ...
        if (in_array($fileType, $allowedTypes)) {
            ...
            die('Type de fichier non autorisé. Veuillez choisir une image au format JPEG, PNG ou GIF.');
        }
    } else {
    ...
    try {
        $produitsController->addProduit($produit);
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="base">
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="pg.php">
                        <span class="sub-item">liste event</span>
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="../reclamations_manage.php">
                        <span class="sub-item">reclamations manage</span>
                      </a>
                    </li>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form method="POST" id="ajoutForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <label for="productPass">Prix/Pass :</label>
                          <input type="number" id="productPass" name="productPass" step="0.01" class="form-control" required>
                        </div>
                        <div class="form-group">
                          <label for="productLieu">Lieu :</label>
                        ...
                        <div class="form-group">
                          ...
                          <input type="file" id="productImage" name="productImage" class="form-control-file" accept="image/*" required>
                        </div>
