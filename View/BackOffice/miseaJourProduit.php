...
// Check if the produit is null or missing key
if ($produit && isset($produit['key'])) {
    echo $produit['key'];
} else {
    echo "Product not found or missing key.";
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['productImage']) && $_FILES['productImage']['error'] == UPLOAD_ERR_OK) {
        ...
        $image = isset($produit['image']) ? $produit['image'] : null;
    }
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form method="POST" id="updateForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="productPrice">Pass:</label>
                                <input type="number" id="productPass" name="productPass" step="0.01" class="form-control" value="<?= $produit['pass']; ?>" required>
                            </div>
                            <div class="form-group">
