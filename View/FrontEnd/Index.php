...
$pdo = $database->connect(); // This will return the PDO connection
...
$query = "SELECT * FROM product";  // Adjust this query as needed
$stmt = $pdo->query($query);       // Use the $pdo object to run the query
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="banner_taital_main">
                        ...
                        <p class="banner_text">
                          Bringing the Farm to Your Table with the Freshest
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <p class="ipsum_text">
                  ...
                  humour, or randomisedvariations of passages of Lorem Ipsum
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <p class="vagetables_text">
          Fresh products picked specially for you !
        </p>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="hover01 column">
            <figure><img src="Assets/images/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" /></figure>
          </div>
          <h3 class="harshal_text"><?php echo htmlspecialchars($product['name']); ?></h3>
          <h3 class="rate_text">TND<?php echo number_format($product['price'], 2); ?></h3>
