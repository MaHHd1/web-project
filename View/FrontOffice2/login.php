...
$error = "";
$success = "";
$recaptcha_secret = "6LfXMaEqAAAAAFdx-CBdS_29ePkOoqeLQCd2IalD"; // Replace with actual Secret Key
...
<header>
    <nav class="navbar">
        ...
        <a href="#" class="logo">
            <img src="images/Farmnet(LOGO).PNG" alt="logo">
            <h2>Organic</h2>
        </a>
        <ul class="links">
    ...
    <div class="form-box login">
        ...
        <div class="form-content">
            ...
            <form method="post" action="login.php">
                ...
                <div class="g-recaptcha" data-sitekey="6LfXMaEqAAAAAFawhw9XBi9CkxuX1ZexigS6w2S2" data-size="normal"></div>
