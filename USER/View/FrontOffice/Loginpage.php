...
require_once '../../Model/model.php';  // Include the User model
...
<header>
    <div class="container-fluid">
        <div class="row py-3 border-bottom">
            ...
            <div class="col-sm-8 offset-sm-2 col-lg-6">
                <div class="search-bar row bg-light p-2 rounded-4 move-right">
                    ...
                    <div class="col-20 col-md-10 ">
                        <form id="search-form" class="text-center w-100" action="index.html" method="post">
                            <input type="text" class="form-control border-0 bg-transparent w-100" placeholder="Search for more">
                        </form>
                    </div>
                    <div class="col-1 ">
