...
if (isset($_SESSION['admin_name']) && isset($_SESSION['admin_image'])) {
    ...
    $adminImage = $_SESSION['admin_image']; // Admin's image URL
} else {
    ...
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
              ...
              <img src="<?php echo isset($_SESSION['admin_image']) ? $_SESSION['admin_image'] : 'assets/img/profile-img.jpg'; ?>" alt="Profile" class="rounded-circle">
              <!-- Display admin name -->
              <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo isset($_SESSION['admin_name']) ? $_SESSION['admin_name'] : 'Admin'; ?></span>
...
<aside id="sidebar" class="sidebar">
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
          <a class="nav-link " href="users-profiles.php">
              <i class="bi bi-person"></i>
              <span>Profile</span>
          </a>
      </li>
