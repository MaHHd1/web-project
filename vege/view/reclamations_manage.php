    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 bg-dark text-white d-flex flex-column sidebar py-4 px-3 shadow">
                ...
                <a href="#" class="text-white mb-3 text-decoration-none"><i class="bi bi-house-door"></i> Dashboard</a>
                <a href="#" class="text-white mb-3 text-decoration-none"><i class="bi bi-people"></i> Users</a>
                <a href="#" class="text-white mb-3 text-decoration-none"><i class="bi bi-box-seam"></i> Products</a>
                <a href="#" class="text-white mb-3 text-decoration-none"><i class="bi bi-gear"></i> Settings</a>
                <a href="#" class="text-white mb-3 text-decoration-none"><i class="bi bi-house-door"></i>Reclamations</a>

                <a href="#" class="text-danger mt-auto text-decoration-none"><i class="bi bi-box-arrow-right"></i> Logout</a>
            </div>
