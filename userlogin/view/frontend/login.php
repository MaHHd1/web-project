...
require_once '../../Controller/UserController.php';  // Adjust the path as necessary
require_once '../../Model/userModel.php';  // Include the User model


if (isset($_POST['disconnect'])) {
// Create a User object (password will be hashed automatically)
...
if (isset($_POST['signup'])) {
    // Create a User object (password will be hashed automatically)
    $user = new User(null, $_POST["name"], $_POST['Email'], $_POST["pwd"]);

    // Create an instance of UserController
    $userController = new UserController();

    // Call the signup method with the User object
...
if (isset($_POST['signin'])) {
    ...
    // Create a User object (password will be hashed automatically when validating during sign-in)
    ...
    $result = $userController->signin($user);

    // Optionally, handle the result
    if ($result) {
        echo "Signin successful!";
        // Redirect user after successful signin (optional)
        // header("Location: dashboard.php");  // Un-comment to redirect
        // exit();
    } else {
        echo "Signin failed!";
    }
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                        ...
                        <small class="text-body1-secondary">Brief description</small>
                    </div>
                    <span class="text-body1-secondary">$12</span>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                    ...
                    <span class="text-body1-secondary">$8</span>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                    ...
                    <span class="text-body1-secondary">$5</span>
                </li>
                ...
                <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
                    ...
                    if (isset($_SESSION['user_id'])) {
                        ...
                        <form method="POST" action="">
                            <button type="submit" name="disconnect" class="nav-link">deconnect</button>
                        </form>
                        <?php
                    }
                    ?>
                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <h6 class="text-muted f-w-400"><?php echo $_SESSION['mail']?></h6>
                                                </div>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <h6 class="text-muted f-w-400"><?php echo $_SESSION['name']?></h6>
                                                </div>
                                                <div class="col-sm-6">
