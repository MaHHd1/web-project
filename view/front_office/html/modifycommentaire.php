...
<head>
    ...
    <!-- site metas -->
    <title>Modify Commentaire</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="layout_border">
            <!-- modify commentaire section start -->
            <div class="container">
                <h2>Modify Commentaire</h2>
                <?php
                ...
                if (isset($_GET['id'])) {
                    ...
                    if ($commentaire) {
                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                            ...
                            if ($commentaireC->modifierCommentaire($id, $contenu, $date_creation_cm, $id_question)) {
                                echo "<script>
                                        alert('Commentaire modified successfully!');
                                        window.location.href = 'listcommentaire.php';
                                      </script>";
                            } else {
                                echo "<script>alert('Unable to modify commentaire.');</script>";
                            }
                        }
                        ?>
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="contenu" name="contenu" rows="4" required><?php echo $commentaire['contenu']; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="date_creation_cm">Creation Date:</label>
                                <input type="date" class="form-control" id="date_creation_cm" name="date_creation_cm" value="<?php echo $commentaire['date_creation_cm']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="id_question">Question ID:</label>
                                <input type="text" class="form-control" id="id_question" name="id_question" value="<?php echo $commentaire['id_question']; ?>" required>
                            </div>
            ...
            <!-- modify commentaire section end -->
            </div>
    </div>
